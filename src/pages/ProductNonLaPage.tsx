...
const IMAGES = [
  {
    ...
    alt: "Áo Thun Unisex - Nón Lá - Đen",
  },
  {
    src: "https://i.ibb.co/ynWcFRFG/9.png",
    alt: "Áo Thun Unisex - Nón Lá - Trắng",
  },
  {
    src: "https://i.ibb.co/S7Qmrfv9/8.png",
    alt: "Áo Thun Unisex - Nón Lá - Hồng",
  },
];
...
export default function ProductNonLaPage() {
          ...
          {activeTab === "description" ? (
            ...
            <div className="font-body-md text-body-md text-on-surface-variant space-y-4">
              <div className="border-b border-outline-variant/50 pb-4">
                ...
                <p className="font-label-md text-label-md text-primary mb-1">Thu Hà</p>
                <p>Hình in nón lá tinh tế, mang đậm nét Việt Nam. Chất cotton mềm, thoáng mát.</p>
              </div>
              <div className="border-b border-outline-variant/50 pb-4">
                <div className="flex items-center gap-1 text-secondary mb-1">
                  {[1, 2, 3, 4].map((star) => (
                ...
                <p className="font-label-md text-label-md text-primary mb-1">Đức Minh</p>
                <p>Form oversize đẹp, màu trắng sạch sẽ. Đóng gói cẩn thận, giao hàng đúng hẹn.</p>
              </div>
            </div>
          )}
        </section>
